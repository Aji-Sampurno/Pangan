...
<div class="card shadow mb-4">
	<div class="card-header py-3 py-3 d-flex flex-row align-items-center justify-content-between">
		<h6 class="m-0 fint-weight-bold text-primary">Data Palawija Kosong</h6>
	</div>
	<div class="row">
		<div class="col-lg">
						...
						<tr>
							...
							<?php
								if ($baris->id_admin == $getId) {
									echo '<a href="'.base_url('Admin/edit_statistik_palawija/'.$baris->id_statistik).'"class="fa fa-edit"></a>';
								}
								else 
								{
									echo '';
