...
<div class="card shadow mb-4">
	<div class="card-header py-3 py-3 d-flex flex-row align-items-center justify-content-between">
		<h6 class="m-0 fint-weight-bold text-primary">Data Padi</h6>
	</div>
	<div class="row">
		<div class="col-lg">
					...
					<tbody>
						...
						<tr>
							...
							<?php
								...
								echo '<a href="'.base_url('Admin/lihat_statistik_padi/'.$baris->id_statistik).'"class="fa fa-eye">&nbspLihat Detail</a>&nbsp';
								echo '<a media="print" rel="Alternate" href="'.base_url('Admin/print_statistik_padi/'.$baris->id_statistik).'"class="fa fa-print">&nbspCetak Laporan</a>';
								echo " ";
							?>
							</td>
						</tr>
